...
-- Afișați numele concatenat cu prenumele urmat de virgulă și anul de studiu. 
-- Ordonați crescător după anul de studiu. Denumiți coloana “Studenți pe ani de studiu”.
select nume||prenume||','||an "Studenti pe ani de studiu" 
	from studenti 
	order by an;

-- Afișați numele, prenumele și data de naștere a studenților născuți între 1 ianuarie 1995 si 10 iunie 1997. 
...
-- Afișați studenții (nume și prenume) care iau bursă și sunt în anii 2 și 3 de studiu.
